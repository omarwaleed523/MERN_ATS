...
import { FiUserPlus, FiBriefcase, FiPieChart, FiSearch, FiCpu, FiCheck, FiChevronRight, FiUsers } from 'react-icons/fi';
...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-base-100">
            ...
            <section className="py-16 bg-base-200">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold mb-4">Powerful ATS Features</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {/* Feature Cards 4-6 remain unchanged */}
                        {/* Feature Card 4 */}
                        <div className="bg-base-100 p-6 rounded-xl shadow-md border border-base-300/50 hover:shadow-lg transition-shadow">
                            <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center mb-5">
            ...
            {/* Call to Action Section - Modified based on login status */}
                            ...
                            {!isLoggedIn ? (
                                ...
                                <>
                                    <h2 className="text-3xl md:text-4xl font-bold mb-6">
                                        {user.role === 'Recruiter' ? 'Ready to Find Your Next Great Hire?' : 'Ready to Find Your Dream Job?'}
                                    </h2>
                                    <p className="text-lg md:text-xl opacity-80 mb-10 max-w-2xl mx-auto">
                                        {user.role === 'Recruiter' 
